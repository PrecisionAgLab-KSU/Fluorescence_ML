# -*- coding: utf-8 -*-
"""
Created on Sun Dec 12 11:48:26 2021
...
gpr = MLPRegressor(hidden_layer_sizes=(100), activation='relu', solver='lbfgs', warm_start=True, random_state=1, tol=1e-5, max_iter=600).fit(X,Y)
...
plt.savefig('Regression_N_V6_ANN.png',bbox_inches="tight",dpi=450)
plt.show()
